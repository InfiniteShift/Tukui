...
if E.client == "frFR" then
	...
	L.core_welcome1 = "Bienvenue sur |cffff7d0aShifte|r's edit de |cff1784d1ElvUI|r, version %s"
	L.core_welcome2 = "Tapez |cff1784d1/uihelp|r pour plus d'info, tapez |cff1784d1/elvui|r pour configurer, ou visitez http://www.tukui.org/forums/forum.php?id=84"
