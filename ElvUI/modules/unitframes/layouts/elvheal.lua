	...
	if unit == "player" then
		...
		if C["unitframes"].unitcastbar == true then
			...
			if C["unitframes"].classbar == true and (E.myclass == "PALADIN" or E.myclass == "SHAMAN" or E.myclass == "DRUID" or E.myclass == "DEATHKNIGHT" or E.myclass == "WARLOCK") then
				castbar:Point("BOTTOMRIGHT", self, "TOPRIGHT", -BORDER, (BORDER*3+10+SPACING))
			else
				castbar:Point("BOTTOMRIGHT", self, "TOPRIGHT", -BORDER, (BORDER*2+BORDER))
			end
...
local function LoadHealLayout()
	...
	pet:Point("BOTTOM", ElvHeal_targettarget, "TOP", 0, 15)
